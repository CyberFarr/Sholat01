...
def update():
      ...
      sp.call(['cd .. && git clone https://github.com/farrij/sholat1'],shell=True, stdout=sp.DEVNULL,stderr=sp.STDOUT)
...
{lg}Nama        : {lw}Sholat
{lg}Versi       : {lw}2.1 (update: 31 jan 2019, 2:18 PM)
{lg}Tanggal     : {lw}31 Januari 2019, 2:18 PM
